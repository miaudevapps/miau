...
export default function CadastroPessoal() {
    ...
    const handleSignUp = async (data: FormValues) => {
        try {
            ...
            userData.pushTokens = expoPushToken ? [expoPushToken] : [];
                ...
                <Layout style={{ alignItems: "center" }}>
                    <Layout style={styles.box}>
                        <Text style={styles.boxText}>
                            ...
                            processo de adoção e/ou apadrinhamento,{"\n"}
                    ...
                    <Layout style={styles.inputContainer}>
                        <Controller
                            ...
                            name="age"
                            rules={{
                                required: "Você precisa cadastrar uma idade",
                            }}
                        />
                    </Layout>
                    <Layout style={styles.inputContainer}>
                        <Controller
                            ...
                            name="email"
                            rules={{
                                required: "Você precisa cadastrar um e-mail",
                            }}
                        />
                    </Layout>
                    <Layout style={styles.inputContainer}>
                        <Controller
                            ...
                            name="state"
                            rules={{
                                required: "Você precisa cadastrar um estado",
                            }}
                        />
                    </Layout>
                    <Layout style={styles.inputContainer}>
                        <Controller
                            ...
                            name="city"
                            rules={{
                                required: "Você precisa cadastrar uma cidade",
                            }}
                        />
                    </Layout>
                    <Layout style={styles.inputContainer}>
                        <Controller
                            ...
                            name="address"
                            rules={{
                                required: "Você precisa cadastrar um endereço",
                            }}
                        />
                    </Layout>
                    <Layout style={styles.inputContainer}>
                        <Controller
                            ...
                            name="phone"
                            rules={{
                                required: "Você precisa cadastrar um telefone",
                            }}
                        />
                    </Layout>
                    ...
                    <Layout style={styles.inputContainer}>
                        <Controller
                            ...
                            rules={{
                                required:
                                    "Você precisa cadastrar um nome de usuário",
                            }}
                        />
                    </Layout>
                    <Layout style={styles.inputContainer}>
