...
export default function DetalhesPet({ route }: any) {
    ...
    const handleVerinteressados = async () => {
        // redireciona para a tela de interessados
        navigation.navigate("Interessados", {
            interessados: animal.interessados,
            animalID: animalID,
        });
    };
        ...
        <Layout style={{ flex: 1, alignItems: "center" }}>
            <ScrollView contentContainerStyle={styles.scrollContent}>
                ...
                <View style={styles.section}>
                    ...
                    <Text style={styles.infoText}>
                        Termo de apadrinhamento, auxílio financeiro com
                        alimentação
                    </Text>
                </View>
                ...
                <View style={styles.section}>
                    ...
                    <Text style={styles.infoText}>
                        ...
                        crianças e outros animais. Ele está disponível para
                        adoção responsável e precisa de ajuda financeira para o
                        seu dia a dia até encontrar um lar fixo.
                    </Text>
                </View>
