        ...
        <Layout style={{ flex: 1 }}>
            <ScrollView contentContainerStyle={styles.scrollContainer}>
                <Layout style={{ alignItems: "center" }}>
                    ...
                    >
                        <Button style={styles.photobutton} onPress={pickImage}>
                            {(evaProps) => (
                    ...
                    <Layout style={styles.radioBox}>
                        <Controller
                            ...
                            name="especie"
                            rules={{
                                required: "Você precisa selecionar uma espécie",
                            }}
                            render={({ field: { onChange, value } }) => (
                                <RadioGroup
                    ...
                    <Layout style={styles.radioBox}>
                        <Controller
                            ...
                            name="sexo"
                            rules={{
                                required: "Você precisa selecionar um sexo",
                            }}
                            render={({ field: { onChange, value } }) => (
                                <RadioGroup
                                    selectedIndex={
                    ...
                    <Layout style={styles.radioBox}>
                        <Controller
                            ...
                            name="porte"
                            rules={{
                                required: "Você precisa selecionar um porte",
                            }}
                            render={({ field: { onChange, value } }) => (
                                <RadioGroup
                                    selectedIndex={
                    ...
                    <Layout style={styles.radioBox}>
                        <Controller
                            ...
                            name="idade"
                            rules={{
                                required: "Você precisa selecionar uma idade",
                            }}
                            render={({ field: { onChange, value } }) => (
                                <RadioGroup
                                    selectedIndex={
